  ...
  <div>
    <div class="mianbaoxie">
      <el-breadcrumb separator-class="el-icon-arrow-right" class="aa">
        ...
        <el-breadcrumb-item>Win专区</el-breadcrumb-item>
      </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    //换页响应事件，根据页码的变化，改变currentPageList里面的软件列表。
  ...
  mounted() {
    this.$store.dispatch("getSoftwaresOnWindows");
  }
}
</script>
